#!/bin/bash
ranklist='/home/sourcecs/sourcecs/dd2/cstrike/addons/sourcemod/configs/army/army_ranks.txt'
armyfile='/home/sourcecs/sourcecs/dd2/cstrike/addons/sourcemod/data/sqlite/army_ranks.sq3'
